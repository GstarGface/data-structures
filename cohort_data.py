...
def sort_by_cohort(filename):
    ...
    for line in the_file:
        ...
        if student_data[4] == "Winter 2015":
            winter_2015.append(student_data[0] + " " + student_data[1])
        elif student_data[4] == "Spring 2015":
            spring_2015.append(student_data[0] + " " + student_data[1])
        elif student_data[4] == "Summer 2015":
            summer_2015.append(student_data[0] + " " + student_data[1])
        elif student_data[2] == "":
            tas.append(student_data[0] + " " + student_data[1])

    all_students = [winter_2015, spring_2015, summer_2015]
    return all_students
    return tas
...
def all_students_tuple_list(filename):
    ...
    for line in the_file:
        student_data = line.rstrip().split("|")
        the_tuples = tuple(student_data)
        list_of_tuples.append(the_tuples)
